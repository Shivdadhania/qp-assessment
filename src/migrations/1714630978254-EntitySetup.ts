...
export class EntitySetup1714630978254 implements MigrationInterface {
  name = 'EntitySetup1714630978254';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "order_detail" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "price" integer NOT NULL, "quantity" integer NOT NULL, "name" character varying(300) NOT NULL, "grocery_id" character varying(300) NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "order_id" uuid, CONSTRAINT "UQ_3aaf3514f1329494c6aabe3fdb5" UNIQUE ("name"), CONSTRAINT "PK_0afbab1fa98e2fb0be8e74f6b38" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
